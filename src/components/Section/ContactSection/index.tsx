...
const ContactSection: React.FC<ContactProps> = ({ lng }) => {
  ...
  const contactList: Contact[] = [
    {
      name: "Behance",
      url: "https://www.behance.net/ismaeljouhari",
      icon: <FaBehance className={iconClass} />,
    },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/ismael-jhri/",
      icon: <FaLinkedin className={iconClass} />,
    },
    {
      name: "Blog",
      url: "https://kulturphoto.club/",
      icon: <FaGhost className={iconClass} />,
    },
    {
      name: "Instagram",
      url: "https://instagram.com/hypsanda",
      icon: <FaInstagram className={iconClass} />,
    },
    {
      name: "Site photo",
      url: "https://ismael.photos",
      icon: <FaSquarespace className={iconClass} />,
    },
    {
      name: "Github",
      url: "https://github.com/ismaeljouhariperez",
  ...
  return (
    <div className="container flex flex-col mx-auto h-80 lg:h-4/6 justify-between">
      <div className="flex flex-col items-center lg:items-start">
        ...
        <Link href="mailto:ismael.jouhari@gmail.com" className="inline-flex">
